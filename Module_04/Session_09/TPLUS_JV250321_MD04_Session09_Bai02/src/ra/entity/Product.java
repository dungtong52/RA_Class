...
public class Product implements IShop {
    ...
    public int inputCatalogId(Scanner scanner) {
        ...
        for (int i = 0; i < CategoryManagement.currentCatalog; i++) {
            System.out.printf("%d. %s", i + 1, CategoryManagement.categories[i].getCatalogName());
        }
    }
    ...
    public void displayData() {
        ...
        System.out.printf("Mô tả: %s - Mã danh mục: %d - Trạng thái: %s",
                this.descriptions, this.catalogId, this.status);
    }
}
